...
public class DistanceCalculatorInput extends AsyncTask<String, Void, String> {

    private IDistanceCalculatorActivity activity;

    public DistanceCalculatorInput(IDistanceCalculatorActivity activity) {
    ...
    protected void onPostExecute(String result) {
        activity.setMapsContainer(result);
    }
}
